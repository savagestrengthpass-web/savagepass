...
export default function EditPerk() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) {
      ...
      alert(`Error updating perk: ${error.message}`);
    } else {
      router.push('/admin/perks');
      router.refresh();
    }
  ...
  return (
    <div className="admin-container" style={{ padding: '2rem', maxWidth: '600px', margin: '0 auto' }}>
      <header style={{ marginBottom: '2rem' }}>
        ...
        <h1 className="heading" style={{ fontSize: '2rem' }}>Edit Perk</h1>
      </header>
      ...
      <form onSubmit={handleSubmit} className="glass-dark" style={{ padding: '2rem', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            ...
            <input required type="text" placeholder="e.g. Iron Grill Steakhouse" className="input-field" style={{ paddingLeft: '40px' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <input type="text" placeholder="Or type a custom category..." className="input-field" style={{ marginTop: '0.5rem' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            ...
            <input required type="text" placeholder="e.g. 15% OFF" className="input-field" style={{ paddingLeft: '40px' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <textarea required placeholder="Describe what's included..." className="input-field" style={{ minHeight: '80px', resize: 'vertical' }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            ...
            <input required type="text" placeholder="e.g. Dine-in only." className="input-field" style={{ paddingLeft: '40px' }}
