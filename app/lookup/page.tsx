...
export default function Home() {
  ...
  async function handleLookup(e: React.FormEvent) {
    ...
    if (queryError || !data) {
      setError('No se encontró ninguna membresía. Por favor, verifica tu ID de Miembro y dirección de correo electrónico.');
    } else {
  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        >
          ...
          <h1 className="heading" style={{
            ...
            Accede a tu <span style={{ color: 'var(--accent)' }}>Pase</span>
          </h1>
          ...
          <p style={{
            ...
            Ingresa tu ID de Miembro y correo electrónico para ver tu tarjeta de membresía digital.
          </p>
          ...
          >
            ...
            >
              <Search size={20} />
              {loading ? 'Buscando...' : 'Encontrar Mi Pase'}
            </button>
          </form>
        </motion.div>
        ...
        >
          {[
            { icon: <QrCode size={14} />, label: 'Verificación QR' },
            { icon: <ShieldCheck size={14} />, label: 'Acceso Seguro' },
            { icon: <Zap size={14} />, label: 'Búsqueda Instantánea' }
          ].map((item, i) => (
            <div
              key={i}
              style={{
      ...
      <footer style={{
        ...
        <p>© 2024 SAVAGE STRENGTH. TODOS LOS DERECHOS RESERVADOS.</p>
      </footer>
    </div>
  );
}
